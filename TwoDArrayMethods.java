...
/**
 * Write a description of class Classwork1 here.
 *
 * @author (your name)
    ...
    */
     ...
     public static void largestinRows(int[][] matrix)
    {
        for(int i = 0; i < matrix.length; i++)
        {
            ...
            System.out.println("The largest value in row " + i + "is" + max);
        }
    ...
    public static void largestinColumns(int[][] matrix)
    {
        for(int i = 0; i < matrix[0].length; i++)
        {
            ...
            System.out.println("The largest value in column " + i + "is" + max);
        }
